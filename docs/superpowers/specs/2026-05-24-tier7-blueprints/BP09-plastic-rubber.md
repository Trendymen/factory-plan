...
1F | 精炼厂×4（3 塑料·1 橡胶）+精炼厂×1（石油焦）+就地回收机×1 | 原油 172.5 | 塑料 115·橡胶 20·石油焦 234（就地回收机消化） | ↑屋顶:塑料·橡胶
```
...
1F | 精炼厂×3（塑料）+精炼厂×1（石油焦）+就地回收机×1（橡胶槽暂未通电） | 原油 172.5 | 塑料 115·石油焦 234（就地回收机消化） | ↑屋顶:塑料
```
