...
1F | constructor×6（2 铜板·3 电线·1 线缆） | 铜锭 326.5 | 铜板+电线+线缆 | ↑2F:铜锭
2F | constructor×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑3F:铜锭
3F | constructor×4（2 铜板·1 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑屋顶:铜板+电线+线缆
屋顶 | 分流+合流 | — | 电线 170·线缆 71.5·铜板 25·混料 70 /min |
```

```floorstack
# BP07b 铜板+电线+线缆 (C3) · Mk2 实例b · 自下而上
1F | constructor×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑2F:铜锭
2F | constructor×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑3F:铜锭
3F | constructor×4（2 铜板·1 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑屋顶:铜板+电线+线缆
屋顶 | 分流+合流 | — | 注入总线 |
```
...
1F | constructor×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板 → BP8·电线+线缆 | ↑2F:铜锭
2F | constructor×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑3F:铜锭
3F | constructor×4（2 铜板·1 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑屋顶:铜板+电线+线缆
屋顶 | 分流+合流 | — | 注入总线 |
```
