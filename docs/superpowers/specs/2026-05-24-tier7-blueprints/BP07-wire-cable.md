...
1F (0-8m) | 建造机×6（2 铜板·3 电线·1 线缆） | 铜锭 326.5 | 铜板+电线+线缆 | ↑2F:铜锭
2F (12-20m) | 建造机×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑3F:铜锭
3F (24-32m) | 建造机×4（2 铜板·1 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑屋顶:铜板+电线+线缆
屋顶 (35-40m) | 汇料台 | — | 多料合送：电线 170·线缆 71.5·铜板 25·其余 70 /min → 外运 |
```

```floorstack
# BP07b 铜板+电线+线缆 (C3) · Mk2 实例b · 自下而上
1F (0-8m) | 建造机×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑2F:铜锭
2F (12-20m) | 建造机×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑3F:铜锭
3F (24-32m) | 建造机×4（2 铜板·1 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑屋顶:铜板+电线+线缆
屋顶 (35-40m) | 汇料台 | — | 电线+线缆+铜板 → 外运 |
```

```floorstack
# BP07c 铜板+电线+线缆 (C3) · Mk2 实例c（14台变体） · 自下而上
1F (0-8m) | 建造机×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板 → 电路板(BP8)·电线+线缆 | ↑2F:铜锭
2F (12-20m) | 建造机×6（2 铜板·3 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑3F:铜锭
3F (24-32m) | 建造机×4（2 铜板·1 电线·1 线缆） | 铜锭 | 铜板+电线+线缆 | ↑屋顶:铜板+电线+线缆
屋顶 (35-40m) | 汇料台 | — | 电线+线缆+铜板 → 外运 |
```

> BP7 三实例（a/b/c），铜锭右向流（铜锭(BP6)→BP7a→BP7b→BP7c→电路板(BP8)）；各层产铜板/电线/线缆，多料合送上屋顶汇料台后外运，电线另有内部回流给线缆。
