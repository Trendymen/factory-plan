...
1F | 建造机×10（5 铁板·5 铁棒） | 铁锭 640/min | 铁棒 → BP2b | ↑2F:铁锭
2F | 建造机×9（6 铁棒·3 铁板） | 铁锭 640/min | 铁棒 → 总线 | ↑3F:铁板
3F | 组装机×3（强化铁板） | 铁板·螺丝 306/min | 强化铁板 25.5/min → 总线 |
...
1F | 建造机×10（5 铁板·5 铁棒，T6 全关） | 铁锭 640/min | 铁锭·铁棒 → BP3 |
2F | 建造机×9（6 铁棒·3 铁板，T6 全关） | 铁锭 640/min | 铁棒 → 总线 | ↑3F:铁板
3F | 组装机×3（强化铁板，T6 全关） | 铁板·螺丝 | 强化铁板 → 总线 |
