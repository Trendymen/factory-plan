...
3F | assembler×3（强化铁板） | 铁板·螺丝 306/min | 强化铁板 25.5/min → 总线 |
屋顶 | 分流+合流 | 螺丝 306/min（反向回流） | 铁棒 140·强化铁板 20.5 注入总线 | ↓3F:螺丝
```
...
3F | assembler×3（强化铁板，T6 全关） | 铁板·螺丝 | 强化铁板 → 总线 |
屋顶 | 分流+合流 | 螺丝 306/min（反向回流） | 螺丝 → BP2a | ↓3F:螺丝
```
