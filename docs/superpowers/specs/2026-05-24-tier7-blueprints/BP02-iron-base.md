...
1F (0-8m) | 建造机×10（5 铁板·5 铁棒） | 铁锭 | 铁棒 → BP2副本(BP2b) | ↑2F:铁锭
2F (12-20m) | 建造机×9（6 铁棒·3 铁板） | 铁锭 | 铁棒/铁板 → 外运 | ↑3F:铁板
3F (24-32m) | 组装机×3（强化铁板） | 铁板 | 强化铁板 → 外运 |
屋顶 (35-40m) | 汇料台 |  | 铁棒/强化铁板 → 外运 | ↓3F:螺丝 | 右:螺丝 ← 螺丝线(BP3)
```

> BP02a 通电 18 台（T6）。螺丝是从下游 BP3 **回流**进来的，所以从**右侧**进屋顶（◀），再下送 3F 强化铁板组装机。

```floorstack
# BP02b 铁板+铁棒+强化铁板 副本 (C1) · Mk2 40×40m · 自下而上（暂未通电，中转管道）
1F (0-8m) | 建造机×10（5 铁板·5 铁棒，暂未通电） | 铁锭 | 铁锭·铁棒 → 送往螺丝线(BP3) |
2F (12-20m) | 建造机×9（6 铁棒·3 铁板，暂未通电） | 铁锭 | 铁棒/铁板 中转 | ↑3F:铁板
3F (24-32m) | 组装机×3（强化铁板，暂未通电） | 铁板 | 强化铁板 中转 |
屋顶 (35-40m) | 汇料台 |  |  | ↓3F:螺丝 | 右:螺丝 ← 螺丝线(BP3) ; 左:螺丝 → BP2主本(BP2a)
```
