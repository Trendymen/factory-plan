...
1F | constructor×10（5 铁板·5 铁棒） | 铁锭 640/min | 铁棒 → BP2b | ↑2F:铁锭
2F | constructor×9（6 铁棒·3 铁板） | 铁锭 640/min | 铁棒 → 总线 | ↑3F:铁板
3F | assembler×3（强化铁板） | 铁板·螺丝 306/min | 强化铁板 25.5/min → 总线 | ↓3F:螺丝
屋顶 | 分流+合流 | 螺丝 306/min（反向回流） | 铁棒 140·强化铁板 20.5 注入总线 |
```

> BP02a 通电 18 台（T6），螺丝经屋顶反向贯穿 belt 从 BP3 回流再下送 3F 强化铁板。

```floorstack
# BP02b 铁板+铁棒+强化铁板 副本 (C1) · Mk2 40×40m · 自下而上（T6 全关，直通管道）
1F | constructor×10（5 铁板·5 铁棒，T6 全关） | 铁锭 640/min | 铁锭·铁棒 → BP3 |
2F | constructor×9（6 铁棒·3 铁板，T6 全关） | 铁锭 640/min | 铁棒 → 总线 | ↑3F:铁板
3F | assembler×3（强化铁板，T6 全关） | 铁板·螺丝 | 强化铁板 → 总线 | ↓3F:螺丝
屋顶 | 分流+合流 | 螺丝 306/min（反向回流） | 螺丝 → BP2a |
```

> BP02b T6 全关，仅作铁锭/铁棒/螺丝直通管道；T7+ 渐次启用内部机器。
