...
1F | 制造器×1（SAM 波动器） | 重生 SAM 60·电线 50·钢管 30 | SAM 波动器 10/min → 上屋顶 | ↑屋顶:SAM 波动器
2F | 建造机×2（重生 SAM） | SAM 矿石 360 | 重生 SAM 90/min（60 下送 1F·30 上屋顶） | ↓1F:重生 SAM 60
屋顶 | 取电线/钢管喂 1F / 产物外运 | 电线 50·钢管 30（外部来料） | 重生 SAM 30·SAM 波动器 10 → 外运 |
```
