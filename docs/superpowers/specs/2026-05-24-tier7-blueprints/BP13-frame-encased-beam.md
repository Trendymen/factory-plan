...
1F | 组装机×4（模块化框架，T6 通电3） | 强化铁板 18·铁棒 72 | 模块化框架 12/min（10→HMF·电脑(BP14)·2→外运） |
2F | 组装机×2（包裹工业梁） | 钢梁 48·混凝土 96 | 包裹工业梁 16/min（10→HMF·电脑(BP14)·6→外运） |
屋顶 | 汇料台 | 强化铁板·铁棒·钢梁·混凝土 | 模块化框架 2·包裹工业梁 6 → 外运 |
```
