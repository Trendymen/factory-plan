...
1F | 组装机×3（转子，T6 通电2） | 螺丝 350·铁棒 70 | 转子 14/min（10→3F·4→外运） | ↑3F:转子
2F | 组装机×3（定子，T6 通电2） | 钢管 45·电线 120 | 定子 15/min（10→3F·5→外运） | ↑3F:定子
3F | 组装机×1（电机） | 转子 10·定子 10 | 电机 5/min → 外运 |
屋顶 | 汇料台 | 螺丝·铁棒·钢管·电线 | 转子 4·定子 5·电机 5 → 外运 |
```
