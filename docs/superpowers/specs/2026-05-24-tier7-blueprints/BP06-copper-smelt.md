...
```floorstack
# BP06a 铜锭+铜金锭 (C3) · Mk2 实例a · 自下而上
1F | smelter×6（5 铜锭·1 铜金锭） | 铜矿石 326.5·铜金矿石 222 | 铜锭 326.5/min → BP6b | ↑2F:铜矿石+铜金矿石
2F | smelter×5（3 铜锭·2 铜金锭） | 铜矿石·铜金矿石 | 铜金锭 74/min | ↑屋顶:铜金锭
屋顶 | 分流+合流 | — | 注入总线 74/min |
```

```floorstack
# BP06b 铜锭+铜金锭 (C3) · Mk2 实例b · 自下而上
1F | smelter×6（5 铜锭·1 铜金锭） | 铜矿石 326.5·铜金矿石 222 | 铜锭 326.5/min → BP6c | ↑2F:铜矿石+铜金矿石
2F | smelter×5（3 铜锭·2 铜金锭） | 铜矿石·铜金矿石 | 铜金锭 74/min → BP6a | ↓1F:铜金锭
屋顶 | 总线直通 | — | — |
```

```floorstack
# BP06c 铜锭+铜金锭 (C3) · Mk2 实例c · 自下而上
1F | smelter×6（5 铜锭·1 铜金锭） | 铜矿石 326.5·铜金矿石 222 | 铜锭 326.5/min → BP7 | ↑2F:铜矿石+铜金矿石
2F | smelter×5（3 铜锭·2 铜金锭） | 铜矿石·铜金矿石 | 铜金锭 74/min → BP6b | ↓1F:铜金锭
屋顶 | 总线直通 | — | — |
```

> BP6 三实例（a/b/c）布局相同；铜锭右向流（BP6a→BP6b→BP6c→BP7），铜金锭反向汇聚到 BP6a 后注入总线。
