...
1F | 组装机×3（电路板） | 铜片 27.5·塑料 55 | 电路板 → 上屋顶汇总 | ↑屋顶:电路板
2F | 组装机×3（电路板） | 铜片·塑料 | 电路板 → 上屋顶汇总 | ↑屋顶:电路板
3F | 组装机×2（电路板） | 铜片·塑料 | 电路板 → 上屋顶汇总 | ↑屋顶:电路板
屋顶 | 取塑料喂各层 / 电路板汇总外运 | 塑料 525.6（外部来料） | 电路板 131.4/min → 送 HMF·电脑(BP14)、晶振(BP15) |
```
