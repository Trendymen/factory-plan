...
1F | 组装机×3（电路板） | 铜片 27.5·塑料 55 | 电路板 → BP14/BP15 | ↑屋顶:电路板
2F | 组装机×3（电路板） | 铜片·塑料 | 电路板 → BP14/BP15 | ↑屋顶:电路板
3F | 组装机×2（电路板） | 铜片·塑料 | 电路板 → BP14/BP15 | ↑屋顶:电路板
屋顶 | 总线取塑料注电路板 | 塑料 525.6 | 电路板 131.4/min |
```

> 三层各放 3/3/2 台组装机；铜片走集群内短 belt 进各层、塑料从屋顶下行喂各层；电路板各层上行汇入屋顶总线，先取塑料后注电路板防误取。
